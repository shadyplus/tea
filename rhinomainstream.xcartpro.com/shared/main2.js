...
(function($) {
    ...
    window.addEventListener('DOMContentLoaded', function() {
        ...
        orderValidator.addRule('name', orderValidator.errorNameField, 'length', {
            minlength: 2
        });
        ...
        orderValidator.addMessages('name', {
            required: orderValidator.errorNameMess,
            minlength: orderValidator.errorNameMess
        });
        orderValidator.addMessages('phone', {
            phone: orderValidator.errorPhoneMess
        });

        orderValidator.addRule('other\[email\]', orderValidator.errorEmailField, 'email');
        orderValidator.addMessages('other\[email\]', {
            email: orderValidator.errorEmail
        });

        orderValidator.addRule('email', orderValidator.errorEmailField, 'email');
        orderValidator.addMessages('email', {
            email: orderValidator.errorEmail
        });
    ...
    function fixForm(form) {
        ...
        var d = new Date(),
            ...
            visitDuration = parseInt(d.getTime() / 1000 - app.timestamp);
